...
HD_PWD='E:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_led.tcl
