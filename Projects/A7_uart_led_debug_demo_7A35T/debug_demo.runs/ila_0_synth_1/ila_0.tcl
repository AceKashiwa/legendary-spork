...
synth_design -top ila_0 -part xc7a35tcsg324-1 -mode out_of_context
...
if { [catch {
  file copy -force E:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.runs/ila_0_synth_1/ila_0.dcp e:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.srcs/sources_1/ip/ila_0_9/ila_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub e:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.srcs/sources_1/ip/ila_0_9/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub e:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.srcs/sources_1/ip/ila_0_9/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim e:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.srcs/sources_1/ip/ila_0_9/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim e:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.srcs/sources_1/ip/ila_0_9/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if {[file isdir E:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force e:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.srcs/sources_1/ip/ila_0_9/ila_0_stub.v E:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.ip_user_files/ip/ila_0
  }
}

if {[file isdir E:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force e:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.srcs/sources_1/ip/ila_0_9/ila_0_stub.vhdl E:/SC_Vivado/A7_uart_led_debug_demo_7A35T/debug_demo.ip_user_files/ip/ila_0
  }
}
