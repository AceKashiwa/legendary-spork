...
#
# Generated by Vivado on Thu Jan 12 17:12:44 +0800 2017
...
# Script info
echo -e "ila_0.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./ila_0.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../../debug_demo.srcs/sources_1/ip/ila_0_3/ila_v6_0_1/hdl/verilog" +incdir+"$ref_dir/../../../../debug_demo.srcs/sources_1/ip/ila_0_3/ltlib_v1_0_0/hdl/verilog" +incdir+"$ref_dir/../../../../debug_demo.srcs/sources_1/ip/ila_0_3/xsdbm_v1_1_1/hdl/verilog" +incdir+"$ref_dir/../../../../debug_demo.srcs/sources_1/ip/ila_0_3/xsdbs_v1_0_2/hdl/verilog" \
    "$ref_dir/../../../../debug_demo.srcs/sources_1/ip/ila_0_3/sim/ila_0.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.ila_0 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.ila_0 -input simulate.do
}
# Script usage
usage()
{
