...
#
# Generated by export_simulation on Sun Jan 08 14:47:37 +0800 2017
#
################################################################################
...
switch to the './ila_demo.sh' script.

./ila_demo.sh -reset_run
...
./ila_demo.sh -noclean_files

For more information on the script, please type './ila_demo.sh -help'.
