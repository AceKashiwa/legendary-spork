...
HD_PWD='E:/w1/bt_uart/bt_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bt_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bt_uart.tcl -notrace
