...
HD_PWD='E:/w1/bt_uart/bt_uart.runs/clk_core_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_core.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_core.tcl
