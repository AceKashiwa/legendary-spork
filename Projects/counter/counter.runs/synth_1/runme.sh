...
HD_PWD='E:/SC_Vivado/counter/counter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_wrapper.tcl
